...
const ContactUs = ({ centreAide = false }) => {
      ...
      emailjs.send(serviceID, templateID, formData, publicKey).then(
        () => {
          ...
          localStorage.setItem(
            "submissionMessage",
            "Votre demande a été envoyée à LocaTech. Nous reviendrons vers vous dans les plus brefs délais !"
          );
  ...
  return (
    <div className="bg-white">
      {!centreAide && (
        <div
          className="h-150 bg-cover bg-center flex flex-col items-center justify-center text-white text-center px-4 mt-12"
      ...
      <div className="flex justify-center -mt-20 px-4 z-20 relative">
        <div
          className={`bg-white ${
            !centreAide && "shadow-lg"
          } rounded w-full max-w-4xl p-8`}
        >
          <p className="mb-8 text-center text-gray-700">
            Afin de répondre au mieux à vos questions, nous vous invitons à
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <select
                    ...
                    className={`w-full border ${
                      errors.profile
                        ...
                        ? "border-green-500"
                        : "border-gray-300"
                    } rounded px-4 py-2 focus:ring-2 focus:ring-red-500 focus:outline-none`}
            ...
            <p className="text-xs text-center text-gray-500 mt-2">
              En cochant cette case, j’accepte le traitement de mes données
              selon{" "}
