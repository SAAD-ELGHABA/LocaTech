...
function Achat({ setValideAffaireData, valideAffaireData }) {
  return (
    <form action="" className="w-[90%] grid gap-3">
      <div className="flex-1 mb-4 md:mb-0 ">
        <label className="block text-sm font-medium mb-1 text-gray-700">
          Budget final en nombre
        </label>
        <input
          type="number"
          ...
          onChange={(e) => {
            ...
            newLetter = newLetter.charAt(0).toUpperCase() + newLetter.slice(1);
        ...
        <div className="mt-2">
          ...
          <span className="text-[#f56565] font-bold text-xs">
            ...
            }).format(valideAffaireData?.budget_Numbre)}{" "}
            MAD
          </span>
        </div>
      </div>
