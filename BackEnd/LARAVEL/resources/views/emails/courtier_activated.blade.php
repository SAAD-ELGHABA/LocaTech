        ...
        <tr>
            <td style="padding: 40px;">
                <p style="font-size: 16px; color: #111827; margin: 0 0 16px 0;">
                    Bonjour <strong>{{ $courtier->user->nom }} {{ $courtier->user->prenom }}</strong>,
                </p>

                <p style="font-size: 16px; color: #374151; margin: 0 0 16px 0; line-height: 1.5;">
                    Nous sommes heureux de vous informer que votre compte sur notre plateforme a été <strong>activé avec succès</strong> !
                </p>

                <p style="font-size: 16px; color: #374151; margin: 0 0 24px 0;">
                    Vous pouvez dès maintenant vous connecter et profiter de nos services en utilisant l'adresse email associée à votre compte ou réinitialiser votre mot de passe si nécessaire.
                </p>
            ...
            <td style="background-color: #f3f4f6; text-align: center; padding: 24px;">
                <p style="margin: 0 0 12px 0;">
                    <a href="https://facebook.com" style="margin: 0 8px; display: inline-block;">
                        <img src="https://img.icons8.com/?size=100&id=118497&format=png&color=000000" width="24"
                            alt="Facebook" style="vertical-align: middle; max-width: 25px;">
                    </a>
                    <a href="https://instagram.com" style="margin: 0 8px; display: inline-block;">
                        <img src="https://img.icons8.com/?size=100&id=BrU2BBoRXiWq&format=png&color=000000" width="24"
                            alt="Instagram" style="vertical-align: middle; max-width: 25px;">
                    </a>
                    <a href="https://linkedin.com" style="margin: 0 8px; display: inline-block;">
                        <img src="https://img.icons8.com/?size=100&id=phOKFKYpe00C&format=png&color=000000" width="24"
                            alt="LinkedIn" style="vertical-align: middle; max-width: 25px;">
                    </a>
                    <a href="https://twitter.com" style="margin: 0 8px; display: inline-block;">
                        <img src="https://img.icons8.com/?size=100&id=13930&format=png&color=000000" width="24"
                            alt="Twitter" style="vertical-align: middle; max-width: 25px;">
                    </a>
                </p>
